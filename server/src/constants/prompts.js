...
Important rules:
- Return projects and certifications as arrays of OBJECTS only, never arrays of plain strings
- If only a project or certification name is available, put it in the "name" field and leave the other fields empty
- Extract EVERYTHING you can find
- Convert dates to YYYY-MM format when possible
- If information is missing, leave as empty string or empty array
