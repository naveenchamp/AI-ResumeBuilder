    ...
    <div>
      ...
      <section className="landing-hero">
        <div className="landing-hero-content">
          ...
          <p className="text-body" style={{ marginTop: '16px', fontSize: '17px', color: 'var(--text-muted)', maxWidth: '520px' }}>
      ...
      {/* E. How It Works */}
      <section id="how-it-works" className="landing-section" style={{ background: 'rgba(30, 41, 59, 0.55)', borderRadius: '24px' }}>
      ...
      <section className="landing-cta">
        ...
        <div style={{ marginTop: '32px' }}>
          <Link to="/login" className="btn btn-primary-gradient" style={{ padding: '14px 36px', fontSize: '16px' }}>
            Get Started <HiArrowRight />
          </Link>
        </div>
