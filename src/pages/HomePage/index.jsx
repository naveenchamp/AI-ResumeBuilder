              ...
              <div className="template-preview-modal" onClick={(e) => e.stopPropagation()}>
                <div style={{ padding: '20px 28px', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                    <button onClick={() => setPreviewTemplate(null)} style={{ background: 'none', border: 'none', cursor: 'pointer', color: 'var(--text-muted)', fontSize: '22px', display: 'flex' }}>
                      <HiXMark />
                    </button>
                    <div>
                ...
                <div style={{ flex: 1, overflow: 'auto', padding: '32px', background: 'var(--bg-soft)', display: 'flex', justifyContent: 'center', alignItems: 'flex-start' }}>
                  <div style={{
                    width: '794px',
                    minHeight: '1100px',
                    background: '#ffffff',
              ...
              {!isUploading ? (
                <>
                  <label className={`upload-dropzone ${uploadFile ? 'upload-dropzone-active' : ''}`}>
                    ...
                    />
                    <HiArrowUpTray style={{ fontSize: '32px', color: 'var(--primary)', marginBottom: '8px' }} />
                  ...
                  {uploadFile && (
                    <div className="upload-file-info">
                      <HiDocumentText style={{ fontSize: '20px', color: 'var(--primary)' }} />
