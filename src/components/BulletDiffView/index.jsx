    ...
    <div className="card card-flush overflow-hidden">
      <div className="grid-2" style={{ gap: 0 }}>
        ...
        <div style={{ borderRight: '1px solid var(--border)' }}>
          <div className="diff-original" style={{ borderRadius: 0, border: 'none', borderBottom: '1px solid rgba(239, 68, 68, 0.35)' }}>
        ...
        {/* Improved */}
        <div>
          <div className="diff-improved" style={{ borderRadius: 0, border: 'none', borderBottom: '1px solid rgba(34, 197, 94, 0.35)' }}>
      ...
      {/* Actions */}
      <div className="flex-row justify-end gap-sm p-sm border-bottom" style={{ background: 'var(--input-bg)' }}>
        <button
          onClick={onReject}
